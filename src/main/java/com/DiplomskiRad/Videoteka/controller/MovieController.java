...
public class MovieController {
    ...
    public String editMovie(Model model, @PathVariable Long id, String keyword){
            ...
            MovieDto updateMovies= movieService.findMoviebyId(id);
    ...
    public String edit(Model model,
                       @Valid @ModelAttribute("updateMovies") MovieDto updateMovies,
    ...
    public String submitForm(@Valid @ModelAttribute("movies") MovieDto movies,
                             @RequestParam("ids") List<GenreDto> genres,
                             Model model){
